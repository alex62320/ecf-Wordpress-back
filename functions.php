...
function wpct_enqueue_styles() {
    ...
    get_stylesheet_directory_uri().'/style.css', ['bootstrap-style','font-awesome-style', 'google-font-style', 'tailwind-elements-style']);
}
...
function wpct_enqueue_scripts() {
    ...
    // false indique qu'il ne faut pas ajouter de numéro de version après le chemin de script
